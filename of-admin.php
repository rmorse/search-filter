...
*/
	...
	function searchandfilter_menu_pages()
	{
		...
		$page_title = __( 'Search &amp; Filter Settings', 'searchandfilter' );
		$menu_title = __( 'Search &amp; Filter', 'searchandfilter' );
		...
		$sub_menu_title = __( 'Settings', 'searchandfilter' );
		//add_submenu_page($menu_slug, $page_title, $sub_menu_title, $capability, $menu_slug, $function);

		// Now add the submenu page for Help
		$submenu_page_title = __( 'Search &amp; Filter Help', 'searchandfilter' );
		$submenu_title = __( 'Help', 'searchandfilter' );
	...
	function searchandfilter_settings()
	{
		if (!current_user_can('manage_options')) {
			wp_die( __( 'You do not have sufficient permissions to access this page.', 'searchandfilter' ) );
		}
		echo '
		...
		echo '<h2>' . __( 'Search &amp; Filter', 'searchandfilter' ) . '</h2>';
		echo '<h3>' . __( 'About', 'searchandfilter' ) . '</h3>';
		...
		echo '<h3>' . __( 'Documentation', 'searchandfilter' ) . '</h3>';
		echo '<div class="of-caption">
		...
		echo '<h3>' . __( 'How To Use', 'searchandfilter' ) . '</h3>';
		echo '<div class="of-caption">
		...
		echo '<h3>' . __( 'Arguments', 'searchandfilter' ) . '</h3>';
		...
		echo '<h3>' . __( 'Your Public Taxonomies', 'searchandfilter' ) . '</h3>';
		...
		echo '<h3>' . __( 'Your Public Post Types', 'searchandfilter' ) . '</h3>';
		...
		echo '<h3>' . __( 'Styling', 'searchandfilter' ) . '</h3>';
		echo '<div class="of-caption">
		...
		echo '<h3>' . __( 'Search &amp; Filter Prefers Clean URLs!', 'searchandfilter' ) . '</h3>';
		echo '<div class="of-caption">
		...
		echo '<h3>' . __( 'Links', 'searchandfilter' ) . '</h3>';
		echo '<div class="of-caption">
				<ul>
...
*/
	...
	function searchandfilter_plugin_action_links($links, $file)
	{
		...
		if ($file == $this_plugin)
		{
			...
			$settings_link = '<a href="' . get_admin_url() . 'admin.php?page=searchandfilter-settings">' . __( 'Settings', 'searchandfilter' ) . '</a>';
